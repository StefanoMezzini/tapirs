...
The overall mean home range estimate was 8.31 km^2^ with CI (6.53, 10.42) km^2^ (see Table 1 above).
...
Figure 1 is not be recreated here because the final version was created in Photoshop. The code to create the figure's components can be found in the `R` script `analysis/maps.R`.
